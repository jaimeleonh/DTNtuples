...
inputFiles = ['MuonAgeingAndFailures_3000fbm1_DT_L1TTDR_v1_mc.db'] 
#inputFiles = ['ageingInput=sqlite_file:MuonAgeingAndFailures_3000fbm1_DT_L1TTDR_v1_mc.db'] 
# E.g. use dedicated tTrigs
...
config.General.requestName = 'DTDPGNtuples_PU200_aged_ST_vAll'
config.General.transferOutputs = True

config.section_('JobType')
config.JobType.pluginName  = 'Analysis'
config.JobType.psetName    = 'dtDpgNtuples_phase2_SliceTest_cfg.py'
...
config.Data.outLFNDirBase  = '/store/user/jleonhol/PU200_aged_ST_vAll'
