...
void DTNtupleTPGSimAnalyzer::book()
{
  ...
  std::vector<std::string> quTags    = { "AllBX", "GoodBX", "GoodBX+index0", "GoodBX+index01","GoodBX+index012","GoodBX+index0123","AllBX+qu>=3","GoodBX+qu>=3", "GoodBX+matchedqu<3", "GodBX+qu>=3+RPCseg", "GoodBX+qu>=3+RPCseg+clus","GoodBX+matchedqu<3+RPCseg", "GoodBX+matchedqu<3+RPCseg+clus"};
...
void DTNtupleTPGSimAnalyzer::fill()
{
  ...
  bool AMprimitiveBX[quTags.size()][5][12][4][7]; 
  bool HBprimitive[quTags.size()][5][12][4]; 
  bool HBprimitiveBX[quTags.size()][5][12][4][7]; 
  ...
  for (int i = 0; i < 5; i++) {
	...
	HBprimitive[0][trigHBWh+2][trigHBSec-1][trigHBSt-1]=true;
        m_plots["bandwidthHB" + whTags.at(trigHBWh+2) + secTags.at(trigHBSec-1) + chambTags.at(trigHBSt-1)]->Fill(1);
	if (trigHBquality >= 4) {HBprimitive[6][trigHBWh+2][trigHBSec-1][trigHBSt-1]=true; numberOfHBTotalPrimitives[trigHBWh+2][trigHBSec-1][trigHBSt-1][6]++;m_plots["bandwidthHB" + whTags.at(trigHBWh+2) + secTags.at(trigHBSec-1) + chambTags.at(trigHBSt-1)]->Fill(7);}
        if (trigHBBX == goodBX) {
          numberOfHBTotalPrimitives[trigHBWh+2][trigHBSec-1][trigHBSt-1][1]++;
	  HBprimitive[1][trigHBWh+2][trigHBSec-1][trigHBSt-1]=true;  
	  m_plots["bandwidthHB" + whTags.at(trigHBWh+2) + secTags.at(trigHBSec-1) + chambTags.at(trigHBSt-1)]->Fill(2);
	  if (trigHBindex <= 1){ HBprimitive[2][trigHBWh+2][trigHBSec-1][trigHBSt-1]=true;  numberOfHBTotalPrimitives[trigHBWh+2][trigHBSec-1][trigHBSt-1][2]++;          m_plots["bandwidthHB" + whTags.at(trigHBWh+2) + secTags.at(trigHBSec-1) + chambTags.at(trigHBSt-1)]->Fill(3);}
	  if (trigHBindex <= 2){ HBprimitive[3][trigHBWh+2][trigHBSec-1][trigHBSt-1]=true;  numberOfHBTotalPrimitives[trigHBWh+2][trigHBSec-1][trigHBSt-1][3]++;m_plots["bandwidthHB" + whTags.at(trigHBWh+2) + secTags.at(trigHBSec-1) + chambTags.at(trigHBSt-1)]->Fill(4);}
	  if (trigHBindex <= 3){ HBprimitive[4][trigHBWh+2][trigHBSec-1][trigHBSt-1]=true;  numberOfHBTotalPrimitives[trigHBWh+2][trigHBSec-1][trigHBSt-1][4]++;m_plots["bandwidthHB" + whTags.at(trigHBWh+2) + secTags.at(trigHBSec-1) + chambTags.at(trigHBSt-1)]->Fill(5);}
	  if (trigHBindex <= 4){ HBprimitive[5][trigHBWh+2][trigHBSec-1][trigHBSt-1]=true;  numberOfHBTotalPrimitives[trigHBWh+2][trigHBSec-1][trigHBSt-1][5]++;m_plots["bandwidthHB" + whTags.at(trigHBWh+2) + secTags.at(trigHBSec-1) + chambTags.at(trigHBSt-1)]->Fill(6);}
	  if (trigHBquality >= 4){ HBprimitive[7][trigHBWh+2][trigHBSec-1][trigHBSt-1]=true;   numberOfHBTotalPrimitives[trigHBWh+2][trigHBSec-1][trigHBSt-1][7]++;m_plots["bandwidthHB" + whTags.at(trigHBWh+2) + secTags.at(trigHBSec-1) + chambTags.at(trigHBSt-1)]->Fill(8);}
	}
      }
	...
	if (trigAMquality >= 3) {AMprimitive[6][trigAMWh+2][trigAMSec-1][trigAMSt-1]=true; numberOfAMTotalPrimitives[trigAMWh+2][trigAMSec-1][trigAMSt-1][6]++;m_plots["bandwidthAM" + whTags.at(trigAMWh+2) + secTags.at(trigAMSec-1) + chambTags.at(trigAMSt-1)]->Fill(7);}
        if (trigAMBX == goodBX) {
	  ...
	  if (trigAMquality >= 3){ AMprimitive[7][trigAMWh+2][trigAMSec-1][trigAMSt-1]=true;   numberOfAMTotalPrimitives[trigAMWh+2][trigAMSec-1][trigAMSt-1][7]++;m_plots["bandwidthAM" + whTags.at(trigAMWh+2) + secTags.at(trigAMSec-1) + chambTags.at(trigAMSt-1)]->Fill(8);}
	  if (trigAMquality >= 3 || ( trigAMquality < 3 && trigAMquality>0 && trigAMrpc!=0 )){ AMprimitive[8][trigAMWh+2][trigAMSec-1][trigAMSt-1]=true;   numberOfAMTotalPrimitives[trigAMWh+2][trigAMSec-1][trigAMSt-1][8]++;m_plots["bandwidthAM" + whTags.at(trigAMWh+2) + secTags.at(trigAMSec-1) + chambTags.at(trigAMSt-1)]->Fill(9);}
	  if (trigAMquality >= 3 ||  (trigAMquality == -1 && trigAMrpc==2) ){ AMprimitive[9][trigAMWh+2][trigAMSec-1][trigAMSt-1]=true;   numberOfAMTotalPrimitives[trigAMWh+2][trigAMSec-1][trigAMSt-1][9]++;m_plots["bandwidthAM" + whTags.at(trigAMWh+2) + secTags.at(trigAMSec-1) + chambTags.at(trigAMSt-1)]->Fill(10);}
	  if (trigAMquality >= 3 ||  (trigAMquality == -1 && ( trigAMrpc==2 || trigAMrpc==3)) ){ AMprimitive[10][trigAMWh+2][trigAMSec-1][trigAMSt-1]=true;   numberOfAMTotalPrimitives[trigAMWh+2][trigAMSec-1][trigAMSt-1][10]++;m_plots["bandwidthAM" + whTags.at(trigAMWh+2) + secTags.at(trigAMSec-1) + chambTags.at(trigAMSt-1)]->Fill(11);}
	  if (trigAMquality >= 3 || ( trigAMquality < 3 && trigAMquality>0 && trigAMrpc!=0 ) ||  (trigAMquality == -1 && trigAMrpc==2)  ){ AMprimitive[11][trigAMWh+2][trigAMSec-1][trigAMSt-1]=true;   numberOfAMTotalPrimitives[trigAMWh+2][trigAMSec-1][trigAMSt-1][11]++;m_plots["bandwidthAM" + whTags.at(trigAMWh+2) + secTags.at(trigAMSec-1) + chambTags.at(trigAMSt-1)]->Fill(12);}
	  if (trigAMquality >= 3 || ( trigAMquality < 3 && trigAMquality>0 && trigAMrpc!=0 ) ||  (trigAMquality == -1 && ( trigAMrpc==2 || trigAMrpc==3)) ){ AMprimitive[12][trigAMWh+2][trigAMSec-1][trigAMSt-1]=true;   numberOfAMTotalPrimitives[trigAMWh+2][trigAMSec-1][trigAMSt-1][12]++;m_plots["bandwidthAM" + whTags.at(trigAMWh+2) + secTags.at(trigAMSec-1) + chambTags.at(trigAMSt-1)]->Fill(13);}
...
void DTNtupleTPGSimAnalyzer::endJob()
{
  ...
  std::vector<std::string> quTags    = { "AllBX", "GoodBX", "GoodBX+index0", "GoodBX+index01","GoodBX+index012","GoodBX+index0123","AllBX+qu>=3","GoodBX+qu>=3", "GoodBX+matchedqu<3", "GodBX+qu>=3+RPCseg", "GodBX+qu>=3+RPCseg+clus","GoodBX+matchedqu<3+RPCseg", "GoodBX+matchedqu<3+RPCseg+clus"};
