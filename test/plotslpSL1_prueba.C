...
string namePlot = "hTanPsiRes_AM3h_MB4_P2";
...
RooRealVar x("x","",-0.05,0.05);
//RooRealVar x("x","",-0.06,0.06);
RooRealVar mean("mean",",mean of Gaussian",0.,-0.01,0.01);
RooRealVar sigma1("sigma1",",width of narrow Gaussian",0.001,0,0.01);
RooRealVar sigma2("sigma2",",width of wide Gaussian",0.01,0,0.03);
